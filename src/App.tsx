  ...
  return (
    <div ref={ref} className="group">
      <div className="flex justify-between items-center mb-2">
        <span className="font-mono text-xs tracking-widest text-[#888] uppercase">
          {label}
        </span>
        <span className="font-mono text-xs text-[#c8ff57]">
          {filled > 0 ? `${level}%` : "—"}
        </span>
      </div>
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#f0ede8] relative">
      ...
      <section
        id="home"
        className="pt-14 min-h-screen flex flex-col justify-between relative overflow-hidden"
      >
        {/* Grid lines */}
        <div
        ...
        <div className="flex-1 flex flex-col justify-center px-6 md:px-12 pt-12 pb-8 max-w-6xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-end">
            <p className="text-lg text-[#666] leading-relaxed max-w-md">
              A Software Engineering student. Focused on building simple,
              efficient, and reliable applications. I am always learning and
              aiming to write clean, maintainable code.
            </p>
        ...
        <div className="border-t border-[#1a1a1a] py-3 overflow-hidden">
          <div className="flex whitespace-nowrap marquee-track">
            {TICKER_ITEMS.map((item, i) => (
              <span
                key={i}
                className="font-mono text-xs text-[#333] tracking-widest uppercase mx-8"
              >
                {item}
      ...
      <section id="projects" className="py-24 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="flex items-end justify-between mb-12 border-b border-[#1a1a1a] pb-6">
          <div>
            <p className="font-mono text-xs text-[#c8ff57] tracking-widest uppercase mb-2">
              02 / Projects
            </p>
            <h2
          ...
          <span className="font-mono text-xs text-[#444] hidden md:block">
          ...
          <div className="grid md:grid-cols-5 gap-12 md:gap-24">
            <div className="md:col-span-2">
              ...
              >
                ...
                behind
                <br />
                the <span className="italic text-[#c8ff57]">code?</span>
              </h2>
            ...
            <div className="md:col-span-3 flex flex-col justify-center">
              <p className="text-lg text-[#aaa] leading-relaxed mb-6">
                I am Rayane. A Software Engineering student. Focused on building
                simple, efficient, and reliable applications. I am always
                learning and aiming to write clean, maintainable code.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  >
                    <div
                      className="font-display font-black text-3xl text-[#c8ff57]"
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-24">
            ...
            <div className="flex flex-col gap-4">
              ...
              {["PostgreSQL", "Docker & CI/CD", "Figma", "Cloud computing"].map((item) => (
                ...
                >
                  <span className="text-[#333] group-hover:text-[#c8ff57] transition-colors font-mono">
                    ▸
                  </span>
                  <span className="group-hover:text-[#f0ede8] transition-colors">
                    {item}
                  </span>
                </div>
              ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
            <div>
              ...
              <h2
                ...
                style={{ fontVariationSettings: '"opsz" 72' }}
              >
                Let's <span className="italic text-[#57e5ff]">build</span>
                <br />
                something.
              </h2>
              <p className="text-[#666] leading-relaxed mb-8 max-w-sm">
                I'm looking for internships, collab projects, and interesting
                problems. If you have one, let's talk.
              </p>
              ...
              >
                <div>
                  <div className="font-mono text-xs text-[#666] uppercase tracking-wider mb-1">
                    Email
                  </div>
                ...
                <span className="ml-auto text-[#333] group-hover:text-[#c8ff57] transition-colors">
                  →
                </span>
              </a>
            </div>
